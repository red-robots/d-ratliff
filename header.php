...
<div id="payment-button"><form action="https://Simplecheckout.authorize.net/payment/CatalogPayment.aspx" method="post" name="PrePage"><input name="LinkId" type="hidden" value="cf577b8c-ddbf-4d2b-a3a6-5903be7219f3" /> <input type="submit" value="Make A Payment" /></form></div>
</div> 
